...
class JustHUD: UIView {
    ...
    private var backColor = UIColor(red: 0.27, green: 0.29, blue: 0.30, alpha: 1.0)
    private var loaderColor = UIColor(red: 173.00/255.0, green: 86.00/255.0, blue: 166.00/255.0, alpha: 1.0)
